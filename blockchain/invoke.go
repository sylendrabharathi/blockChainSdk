...
// InvokeHello
func (setup *FabricSetup) InvokeHello(value interface{}) (string, error) {
	...
	response, err := setup.client.Execute(chclient.Request{ChaincodeID: setup.ChainCodeID, Fcn: args[0], Args: [][]byte{[]byte(args[1]), []byte(args[2]), b}, TransientMap: transientDataMap})
	if err != nil {
