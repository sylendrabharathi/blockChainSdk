...
//
//func getHistory(stub shim.ChaincodeStubInterface, args []string) {
//	state, err := stub.GetHistoryForKey(args[0])
//	if err != nil {
//		return shim.Error("Failed to get state of hello")
//	}
//
...
func (t *HeroesServiceChaincode) getHistory(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	fmt.Println("########### HeroesServiceChaincode getHistory ###########")
	...
	if err != nil {
		return shim.Error("Failed to get history of hello " + err.Error())
	}
	...
	if resultsIterator.HasNext() {
		...
		for resultsIterator.HasNext() {
			...
			//ins["TxId"] = queryResponse.GetTxId()
			//ins["Value"] = string(queryResponse.Value)
			//arr = append(arr, ins)
...
func getHistory(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	//
	//	// Return this value in response
	//	return shim.Success(s.Value)
	//}

	return shim.Success(state)
}

func (t *HeroesServiceChaincode) Query(stub shim.ChaincodeStubInterface, functionName string, args []string) pb.Response {

	if functionName == "getHistory" {
